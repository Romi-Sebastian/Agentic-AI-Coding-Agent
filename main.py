...
def main():
    ...
    When the user asks about the project - they are referring to the working directory. So, you should typically
    start by looking at the project's files, figure out how to run the project and its tests(if available)
