...
schema_write_file = types.FunctionDeclaration(
    name="write_file",
    description="Overwrites an existing file or writes to a new file if it doesn't exist and create required parent "
                "dirs safely, constrained to the working directory.",
